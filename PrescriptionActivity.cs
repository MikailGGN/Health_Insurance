...
namespace NewRelish
{
    ...
    public class PrescriptionActivity : AppCompatActivity, NavigationView.IOnNavigationItemSelectedListener
    {
        protected override void OnCreate(Bundle savedInstanceState)
        {
            base.OnCreate(savedInstanceState);
            SetContentView(Resource.Layout.activity_prescribe);
            ...
            TextView Bartext = FindViewById<TextView>(Resource.Id.textView_homepres);
            ...
            var btn_pharm = FindViewById<Button>(Resource.Id.button_phs);
